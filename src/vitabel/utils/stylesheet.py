...
DEFAULT_PLOT_STYLE = {
    ...
    "Cycle number": {
        "color": "gray",
        "label": r"Breath cycle",
        "linestyle": "",
        "marker": ".",
        "alpha": 0.5,
    },
    "Uncharacterised Breaths": {
        "color": "lightgray",
        "alpha": 0.25,
        "label": "Uncharacterised Breaths",
    },
}
